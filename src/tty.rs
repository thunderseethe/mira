...
pub fn new<T: ToWinsize>(
    user_shell: Option<&Shell>,
    env: &HashMap<String, String>,
    working_dir: Option<PathBuf>,
    size: &T,
    window_id: Option<usize>) -> Pty {
    ...
    let shell = user_shell.unwrap_or(&default_shell);
    ...
    let dir = working_dir.unwrap_or(PathBuf::from(pw.dir));
